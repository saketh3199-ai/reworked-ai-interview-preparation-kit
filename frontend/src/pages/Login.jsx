            ...
            <div className="hidden lg:flex relative flex-col justify-between overflow-hidden bg-neutral-950 px-12 py-14">
                ...
                <div className="max-w-sm">
                    ...
                    <p className="mt-5 text-base leading-relaxed text-neutral-400">
                        Mock interviews, real feedback, and a question bank pulled from
                        actual hiring loops — so the first hard question you hear isn't
                        in the room.
                    </p>

                    <div className="mt-10 border-l-2 border-neutral-800 pl-4 font-mono text-sm leading-loose text-neutral-500">
                        <p><span className="text-emerald-400">Interviewer:</span> Walk me through a time you disagreed with a teammate.</p>
                        <p><span className="text-emerald-400">You:</span> <span className="text-neutral-600">drafting response…</span></p>
                    </div>
                </div>

                <p className="font-mono text-xs text-neutral-600">
                    Trusted by candidates prepping for 400+ companies
                </p>
            </div>
            ...
            <div className="flex items-center justify-center bg-neutral-50 px-6 py-12 sm:px-10">
                <div className="w-full max-w-sm">
                    ...
                    <p className="mt-8 text-center text-sm text-neutral-500">
                        New here?{" "}
                        <Link to="/register" className="font-semibold text-neutral-900 underline underline-offset-2">
                            Create an account
                        </Link>
                    </p>
                </div>
